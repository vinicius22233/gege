...
function getConfig() {
  return {
    ...
    model: {
      ...
      handle: process.env.MODEL_HANDLE || '@eu.mihalyc',
    ...
    plans: {
      monthly: {
        ...
        priceLabel: process.env.PLAN_MONTHLY_PRICE_LABEL || 'R$ 24,90',
        price: parseFloat(process.env.PLAN_MONTHLY_PRICE) || 24.90,
    ...
    redirectUrl: process.env.REDIRECT_URL || 'https://eu.mithalyvip.shop'
  };
}
